...
VOL_TEMPLATE=/usr/local/freesurfer/subjects/$SURF_TEMPLATE/mri/orig.mgz
FINAL_TEMPLATE=$5
...
test -d $SUBJECTS_DIR/$SURF_TEMPLATE || SUBJECTS_DIR=/media/duzzo/TOSHIBA_EXT/VBM_FLICA/prova_flica/outdir/fsaverage
